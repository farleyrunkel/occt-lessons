...
int main(int argc, char **argv)
{
  ...
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(aWire)) , Standard_True);
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(anEdge1)) , Standard_True);
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(anEdge2)) , Standard_True);
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(anEdge3)) , Standard_True);
  ...
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(aMirroredWire)) , Standard_True);
  // vout.StartMessageLoop();
  // return 0;
  ...
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(myBody)) , Standard_True);
  // vout.StartMessageLoop();
  // return 0;
  ...
  // context->SetDisplayMode(AIS_Shaded, Standard_True);
  // context->Display(Handle(AIS_Shape)(new AIS_Shape(threadingWire2)) , Standard_True);
  // vout.StartMessageLoop();
  // return 0;
